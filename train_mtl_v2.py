...
from from multi_task.bert_mtl import MLTBertForSequenceClassification
...
def handle_unmatched(args, device):
    ...
    # save the test results
    print('Saving test results..')
    with open(args.log_dir + '/' + args.setting + '/' + args.model_version + '_' + args.labels + '/test_results.txt', 'w') as json_file:
